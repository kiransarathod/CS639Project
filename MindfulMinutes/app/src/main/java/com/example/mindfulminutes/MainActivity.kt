...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MindfulMinutesTheme {
                HomeScreen(
                    onMoodClick = { startActivity(Intent(this, MoodActivity::class.java)) },
                    onBreathingClick = { startActivity(Intent(this, BreathingActivity::class.java)) },
                    onTrendsClick = { startActivity(Intent(this, TrendsActivity::class.java)) }
                )
            }
        }
    }
